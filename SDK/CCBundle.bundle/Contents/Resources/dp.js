...
!(function (window) {
  ...
  window.dpSliderReload = function () {
    isDpReloading = true
    ...
    var dpSliderReloadTimer = setTimeout(function() {
      if (!isDpReloading) return
      if (window.android && typeof window.android.dpReloadSuccess === 'function') {
        window.android.dpReloadSuccess(false)
      }
      try {
        window.webkit.messageHandlers.dpReloadFail.postMessage({data: 'false'})
      } catch (e) {
      }
      isDpReloading = false
    }, 5000)
    window.dpBufferReady = function () {
      ...
      if (window.android && typeof window.android.dpReloadSuccess === 'function') {
        window.android.dpReloadSuccess(true)
      }
      try {
        window.webkit.messageHandlers.dpReloadSuccess.postMessage({data: 'true'})
      } catch (e) {
      }
      isDpReloading = false
    ...
    window.dpBufferFail = function () {
      ...
      if (window.android && typeof window.android.dpReloadSuccess === 'function') {
        window.android.dpReloadSuccess(dpStatus)
      }
      try {
        window.webkit.messageHandlers.dpReloadFail.postMessage({data: 'false'})
      } catch (e) {
  ...
  window.dpBufferingStart = function () {
    dp.pc.dpBufferingStart()
  }
  window.dpBufferingEnd = function () {
    dp.pc.dpBufferingEnd()
  }
  window.dpBuffering = function (data) {
    console.log('dpBuffering:状态:', data)
  }
  window.dpMessage = function (event) {
    ...
    switch (action) {
      ...
      case 'dp_buffer_error':
        ...
        break
      case 'dp_buffering_end':
        window.dpBufferingEnd()
        break 
      case 'dp_buffering_start':
        window.dpBufferingStart()
        break
      case 'dp_buffering':
