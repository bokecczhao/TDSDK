...
#import "HDMediaPlayback.h"
#import "HDFFMonitor.h"
#import "HDFFOptions.h"
#import "HDSDLGLViewProtocol.h"
...
@interface HDFFMoviePlayerController : NSObject <HDMediaPlayback>

- (id)initWithContentURL:(NSURL *)aUrl
             withOptions:(HDFFOptions *)options;
...
- (id)initWithMoreContent:(NSURL *)aUrl
             withOptions:(HDFFOptions *)options
               withGLView:(UIView<HDSDLGLViewProtocol> *)glView;
...
@property (nonatomic, readonly) HDFFMonitor *monitor;
